package com.sapo.pay.notification.web.rest;

import com.sapo.pay.notification.domain.Notification;
import com.sapo.pay.notification.repository.NotificationRepository;
import com.sapo.pay.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.sapo.pay.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
